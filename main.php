...
<head>
  <meta charset="UTF-8">
  <title>main</title>
  <link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css'><link rel="stylesheet" href="./style2.css">
   <style>
     table, th, td {
...
<nav class="navbar-primary">
  ...
  <ul class="navbar-primary-menu">
    <li>
      ...
      <a href="upload.html"><span class="glyphicon glyphicon-list-alt"></span><span class="nav-label">Upload Medicine Details</span></a>
